...
from app.models.observation import Complaint
...
#
# The proper home is a `ward_period_totals` table. That needs a migration, and
# Alembic has no baseline yet, so this is the interim. See REPORT.md.
